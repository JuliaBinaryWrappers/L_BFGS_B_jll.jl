...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import L_BFGS_B_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("81d17ec3-03a1-5e46-b53e-bddc35a13473"))
platforms = [Pkg.Artifacts.unpack_platform(e, "L_BFGS_B", artifacts_toml) for e in artifacts["L_BFGS_B"]]
...
if best_platform === nothing
    @debug("Unable to load L_BFGS_B; unsupported platform $(triplet(platform_key_abi()))")
else
